  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-foreground/25 relative grow overflow-hidden rounded-full dark:bg-sidebar data-horizontal:h-2 data-horizontal:w-full data-vertical:h-full data-vertical:w-2"
      >
